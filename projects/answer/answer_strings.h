...
prog_char FinSingle[] PROGMEM = "Finished sending single answer";
...
prog_char Help[][50] PROGMEM = {  "------------------------------------------------",
                                  ...
                                  "  k###. - Send answer as MAC ###                ",
                                  "  l - Scan for channel                          ",
                                  "  q - Listen for MASTER CLICKER, then mass send ",
                                  "  y ###### - Set MY MAC address for master input",
                                  "                                                ",
                                  "  Ex: c4m;c1s                                   ",
